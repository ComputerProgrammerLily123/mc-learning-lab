...
Player::Player(glm::vec3 position, Camera *camera, World *world) : position(position), movement(world, 0.08), rayCaster(world, 5, 0.01f), hotbar(), camera(camera), world(world)
{
}

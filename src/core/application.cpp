...
void Application::Run()
{
    while (!window->ShouldClose())
    {
        ...
        auto &canvas = uiSystem.GetMainCanvas();
        auto titleA = Quad(PivotType::Center, FlexType::None, -225, -215, 605.46875f, 171.875f, glm::vec4(0.0f, 1.0f, 0.60546875f, 0.828125f), "title/minecraft.png");
        auto titleB = Quad(PivotType::Center, FlexType::None, 305, -215, 464.84375f, 171.875f, glm::vec4(0.0f, 0.82421875f, 0.46484375f, 0.65234375f), "title/minecraft.png");
        auto buttonA = Button(PivotType::Center, FlexType::None, 0, 0, 728.0f, 88.0f, glm::vec4(0.0f, 0.7421875f, 0.78125f, 0.6640625f), "widgets.png");
        canvas.ClearElement();
 ...
 */
        ...
        /*         camera->SetPosition((player->GetPreviousTickPosition() * (1 - tick.GetAlpha()) + player->GetPosition() * tick.GetAlpha()) + glm::vec3(0.0f, 1.62f, 0.0f));
                ...
                //Test
                uiSystem.CreateQuad(screenWidth / 2 - 364, screenHeight - 88, 88.0f, 88.0f, 0.0f, 0.9140625f, 0.09375f, 0.09375f, "widgets.png");
           */
        input.UpdateKey();
        input.UpdateScroll();

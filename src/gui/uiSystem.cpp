...
UISystem::UISystem(unsigned screenWidth, unsigned scrrenHeight) : screenWidth(screenWidth), screenHeight(scrrenHeight)
{
...
void UISystem::ResizeScreen(unsigned screenWidth, unsigned screenHeight)
{
